...
| API Gateway (v1+v2) | Step Functions | SNS | IAM |
| STS | Secrets Manager | SSM Parameter Store | KMS |
| CloudWatch Logs | CloudWatch Metrics | EC2 | ECS |
| RDS | ElastiCache | ECR | RDS Data |
| EventBridge | Kinesis | Firehose | Glue |
| Athena | SES | WAF v2 | EFS |
| EMR | AppSync | CloudFront | Route 53 |
| ALB | ACM | Service Discovery | Cognito IdP |
| Cognito Identity | CloudFormation | S3Files | |

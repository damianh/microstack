...
{
    public IReadOnlyList<AdminResourceKind> Kinds { get; init; } = [];
}

public sealed record AdminResourceKind(string Id, string Label);
...
{
    public IReadOnlyList<AdminField> Fields { get; init; } = [];
